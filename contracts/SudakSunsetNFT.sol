...
contract SSunNFT is ERC721, ERC721URIStorage, Ownable {
    using Counters for Counters.Counter;
    Counters.Counter private _tokenIds;

    // the name and symbol for the NFT
    constructor() ERC721("SudakSunset", "SSun") {}
   ...
   // receiver takes a type of address. This is the wallet address of the user that should receive the NFT minted using the smart contract
    ...
    function createNFT(address receiver, string memory tokenURIString)
        public onlyOwner
        returns (uint256)
    {
        _tokenIds.increment();
