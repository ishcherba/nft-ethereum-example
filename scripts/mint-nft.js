...
const contract = require("../artifacts/contracts/SudakSunsetNFT.sol/SSunNFT.json");
const contractAddress = "0x542a6902EcBBeDA252bbc3fC3BA38aAcAF9fD686";
...
async function mintNFT(tokenURI) {
  ...
  const tx = {
    ...
    data: nftContract.methods
      .createNFT("0xB4e84B16E3Ba440438d324B07583FC6Fb6B7fA3A", tokenURI)
      .encodeABI(), // call the createNFT function from our SudakSunsetNFT.sol file and pass the account that should receive the minted NFT.
  };
...
mintNFT("https://ipfs.io/ipfs/QmVeUYFG2FYXXvsx4srxUdq4h5nFJxwohKiaKtErSZnSMn"); // pass the CID to the JSON file uploaded to Pinata
